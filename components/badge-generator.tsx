...
function BadgeNotFound() {
  return (
    <div className="text-center p-4 border rounded-md bg-muted">
      <p className="text-destructive font-medium">Repository not found or private</p>
...
type BadgeViewProps = {
  checkIfRepositoryExistsPromise: ReturnType<typeof checkIfRepositoryExists> | Promise<null>
}
...
export function BadgeGenerator() {
  ...
  const [checkIfRepositoryExistsPromise, setCheckIfRepositoryExistsPromise] = useState<ReturnType<typeof checkIfRepositoryExists> | Promise<null>>(Promise.resolve(null))
    ...
    <Card className="w-full">
      ...
      <CardContent className="space-y-6">
        ...
        <BadgegenarateButton 
          ...
          onClick={() => {
            setCheckIfRepositoryExistsPromise(checkIfRepositoryExists({ owner, repo }))
          }}
          disabled={!owner && !repo}
        />

        <Suspense>
          <BadgeView checkIfRepositoryExistsPromise={checkIfRepositoryExistsPromise} />
        </Suspense>
      </CardContent>
    </Card>
  )
